...
[SerializeField] private Transform targetHitPoint;      // Noi Player b?n vào AI
// Cung c?p thu?c tính d? Player có th? truy c?p di?m dích c?a AI
   ...
   private SkillContext BuildSkillContext()
{
    ...
    // ÐI?M QUAN TR?NG: L?y TargetHitPoint c?a Player làm di?m dích
    ...
    return new SkillContext
    {
        ...
        // TargetTransform bây gi? là di?m Hit Point c?a Player
        TargetTransform = hitTransform,
        
        // Ði?m d?n bay ra t? AI
    ...
    private void FlipTowards(float targetX)
    {
        ...
        // N?u m?c tiêu ? bên ph?i AI -> scale x duong (ho?c âm tùy asset)
        // N?u m?c tiêu ? bên trái AI -> scale x ngu?c l?i
