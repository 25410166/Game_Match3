    ...
    public void SpawnNewItemAtRow(int row, bool instant = false)
    {
        ...
        if (comp != null)
        {
            ...
            if (spriteRes != null && spriteRes.spriteItems != null && spriteRes.spriteItems.Length > 0)
            {
                ...
                int gemValue = Board.Instance != null ? Board.Instance.RollGemValueForCurrentTurn() : 1;
                comp.SetItem(spriteRes.spriteItems[idx].id, spriteRes.spriteItems[idx].sprite, gemValue);
            }
